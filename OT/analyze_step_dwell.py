...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        for c in conc:
            ...
            f_tau, tau, s_tau, converged_p, LLE = EM_p.PEM(1)
            ...
            f1, m1, s1, tau1, converged_gp, LLE_gp = EM_gp.GPEM(n_components=1, tolerance=1e-2, rand_init=True)
            ...
            EM_p.plot_fit_exp(xlim=[0, 10], save=True, path=f'mRAD51_{c}_survival.png', figsize=(7,2),
            ...
            EM_gp.plot_gp_contour_2hist(xlim=[0,12], ylim=[0,10], bins_x=np.log2(len(step)).astype('int'),
                                        save=True, path=f'mRAD51_{c}_scatter.png', figsize=(6,5))
